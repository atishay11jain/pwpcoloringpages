-- Coloring Page Assets Schema
-- Run with: wrangler d1 execute coloring-pages-db --remote --file=./migrations/0002_coloring_page_assets.sql

-- Coloring page assets table (R2 storage links)
...
-- Indexes for coloring_page_assets
