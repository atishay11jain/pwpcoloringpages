...
export default function NewSeasonalSpotlightPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Parse page IDs — comma-separated list
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">Add Seasonal Spotlight</h1>
          <p className="text-gray-400 mt-1">Appears as the seasonal/holiday section on the homepage</p>
        </div>
      </div>
        ...
        <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Lower numbers appear first in list view</p>
            </div>
            <div>
